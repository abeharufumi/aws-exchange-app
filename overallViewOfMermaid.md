...
BoostEffects --> DisplayPriority["表示順位: 最上位 (PR マーク付き) 🟠P2-57"]
...
DisplayOrder --> RankPRGod["表示: 最高(PR+God/Goddess) 🟠P2-78"]
DisplayOrder --> RankGod["表示: 最高(God/Goddess) 🔴P1-103"]
DisplayOrder --> RankPR["表示: 最高(PR) 🟠P2-79"]
DisplayOrder --> RankHigh["表示: 高 🔴P1-104"]
DisplayOrder --> RankMid["表示: 中 🔴P1-105"]
DisplayOrder --> RankLow["表示: 低 🔴P1-106"]
RankPRGod --> PRGodMen["男性 Rank5 ブースト中 🟠P2-80"]
RankPRGod --> PRGodWomen["女性 Rank5 ブースト中 🟠P2-81"]
RankGod --> GodMen["男性 Rank5 🔴P1-107"]
RankGod --> GodWomen["女性 Rank5 🔴P1-108"]
RankPR --> PRMen["男性 Rank1-4 ブースト中 🟠P2-82"]
RankPR --> PRWomen["女性 Rank1-4 ブースト中 🟠P2-83"]
