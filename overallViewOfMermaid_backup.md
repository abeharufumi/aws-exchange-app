...
BoostEffects --> DisplayPriority["[P3-11] 表示順位: 最上位 (PR マーク付き) 🟠P2"]
...
DisplayOrder --> RankPRGod["[P3-14] 表示: 最高(PR+God/Goddess) 🟠P2"]
DisplayOrder --> RankGod["[P3-15] 表示: 最高(God/Goddess) 🔴P1"]
DisplayOrder --> RankPR["[P3-16] 表示: 最高(PR) 🟠P2"]
DisplayOrder --> RankHigh["[P3-17] 表示: 高 🔴P1"]
DisplayOrder --> RankMid["[P3-18] 表示: 中 🔴P1"]
DisplayOrder --> RankLow["[P3-19] 表示: 低 🔴P1"]
RankPRGod --> PRGodMen["[P3-20] 男性 Rank5 ブースト中 🟠P2"]
RankPRGod --> PRGodWomen["[P3-21] 女性 Rank5 ブースト中 🟠P2"]
RankGod --> GodMen["[P3-22] 男性 Rank5 🔴P1"]
RankGod --> GodWomen["[P3-23] 女性 Rank5 🔴P1"]
RankPR --> PRMen["[P3-24] 男性 Rank1-4 ブースト中 🟠P2"]
RankPR --> PRWomen["[P3-25] 女性 Rank1-4 ブースト中 🟠P2"]
RankHigh --> HighMen["[P3-26] 男性 Rank4 🟠P2"]
RankHigh --> HighWomen["[P3-27] 女性 Rank4 🟠P2"]
RankMid --> MidMen["[P3-28] 男性 Rank3 🟠P2"]
RankMid --> MidWomen["[P3-29] 女性 Rank3 🟠P2"]
