...
CheckMsgQuota -->|"男性 Rank1 Boost"| MsgMen1B["[P9-3] 上限: 3 通/日 + 追加10通(使い切り) 🟠P2"]
CheckMsgQuota -->|"男性 Rank2 通常"| MsgMen2["[P9-4] 上限: 5 通/日 🟠P2"]
CheckMsgQuota -->|"男性 Rank2 Boost"| MsgMen2B["[P9-5] 上限: 5 通/日 + 追加10通(使い切り) 🟠P2"]
CheckMsgQuota -->|"男性 Rank3 通常"| MsgMen3["[P9-6] 上限: 10 通/日 🟠P2"]
CheckMsgQuota -->|"男性 Rank3 Boost"| MsgMen3B["[P9-7] 上限: 10 通/日 + 追加10通(使い切り) 🟠P2"]
CheckMsgQuota -->|"女性 Rank1 通常"| MsgWomen1["[P9-8] 上限: 3 通/日 🔴P1"]
CheckMsgQuota -->|"女性 Rank1 Boost"| MsgWomen1B["[P9-9] 上限: 3 通/日 + 追加10通(使い切り) 🟠P2"]
CheckMsgQuota -->|"女性 Rank2 通常"| MsgWomen2["[P9-10] 上限: 10 通/日 🟠P2"]
CheckMsgQuota -->|"女性 Rank2 Boost"| MsgWomen2B["[P9-11] 上限: 10 通/日 + 追加10通(使い切り) 🟠P2"]
...
CheckMaleRankBoost -->|"Rank1"| MaleMsgBoost1["[P17-13] 3 通/日 + 追加10通(使い切り) 🟠P2"]
CheckMaleRankBoost -->|"Rank2"| MaleMsgBoost2["[P17-14] 5 通/日 + 追加10通(使い切り) 🟠P2"]
CheckMaleRankBoost -->|"Rank3"| MaleMsgBoost3["[P17-15] 10 通/日 + 追加10通(使い切り) 🟠P2"]
CheckMaleRankBoost -->|"Rank4-5"| MaleMsgBoost45["[P17-16] 無制限 🟠P2"]
CheckFemaleRankBoost -->|"Rank1"| FemaleMsgBoost1["[P17-17] 3 通/日 + 追加10通(使い切り) 🟠P2"]
CheckFemaleRankBoost -->|"Rank2"| FemaleMsgBoost2["[P17-18] 10 通/日 + 追加10通(使い切り) 🟠P2"]
